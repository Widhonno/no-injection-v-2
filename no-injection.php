...
Author: MadDoxX a.k.a AnjingGila
Author URI: http://aming.id
Contributors: I hack the code inc.,
...
function rate_bbq($links, $file) {
	if ($file == plugin_basename(__FILE__)) {
		$rate_url = 'http://aming.id/';
		$links[] = '<a href="http://aming.id/" target="_blank">MadDoxX a.k.a AnjingGila</a>';
	}
	return $links;
}
